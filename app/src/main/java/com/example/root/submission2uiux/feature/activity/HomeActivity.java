...
import com.example.root.submission2uiux.feature.fragment.NowPlayingFragment;
import com.example.root.submission2uiux.feature.fragment.UpComingFragment;
...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                ...
                .add("NOW PLAYING", NowPlayingFragment.class)
                .add("UP COMING", UpComingFragment.class)
                .create());
...
//            fmViewPagerNav.setVisibility(View.VISIBLE);
            fragmentManager = getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.fm_view_pager_nav, new NowPlayingFragment()).commit();
            getSupportActionBar().setTitle("Now Playing");
